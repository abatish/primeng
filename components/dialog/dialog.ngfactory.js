...
function View_Dialog_2(_l) {
    return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, null, null, 1, 'span', [['class',
        ...
        var currVal_0 = _co.ariaLabelledBy;
...
exports.DialogNgFactory = i0.ɵccf('p-dialog', i1.Dialog, View_Dialog_Host_0, { id: 'id', ariaLabelledBy: 'ariaLabelledBy', header: 'header', draggable: 'draggable',
    ...
    visible: 'visible' }, { onShow: 'onShow', onHide: 'onHide', visibleChange: 'visibleChange' }, ['p-header', '*', 'p-footer']);
